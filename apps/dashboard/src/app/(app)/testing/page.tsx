        ...
        {me?.beta ? (
          <section className="rounded-lg border bg-card p-5 shadow-e1">
            ...
            <ol className="mt-5 grid gap-5 md:grid-cols-3">
              <li><p className="text-sm font-semibold">1. Set up your sending address</p><p className="mt-1 text-sm text-muted-foreground">Start with an authenticated Rootmail beta address, or authenticate a domain you own. The beta address keeps replies in your Replies inbox.</p><Link className="mt-2 inline-block text-sm font-medium text-foreground underline underline-offset-4 hover:no-underline" href="/settings/sender">Set up sending →</Link></li>
