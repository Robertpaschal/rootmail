...
export default function DocsPage() {
  return (
    <DocShell title="Quickstart" subtitle="From zero to your first send in three steps.">
      ...
      <ul>
        ...
        <li>See the full plan comparison on the <a href="https://marketing.gateml.io/pricing">pricing page</a>.</li>
      </ul>
    </DocShell>
  );
}
