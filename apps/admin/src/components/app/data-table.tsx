...
/** Shared building blocks for the admin's client-side tables (orgs, leads, support).
 * Each table owns its own filter/sort/page state; these just render the controls. */
