...
// Renders a post/changelog markdown body for the in-admin preview, mirroring the
// marketing site's styling so "how it looks" matches. Safe by default: react-markdown
// does NOT render raw HTML (no rehype-raw), so embedded HTML/script is inert.
