...
// NOTE /v1/live/image.png is listed EXACTLY, not as a /v1/live prefix: the image
// is fetched by mail clients that have no credentials, but its sibling
// /v1/live/sign mints signed URLs and must stay authenticated.
const PUBLIC_PREFIXES = ["/health", "/v1/webhooks", "/v1/auth", "/v1/unsubscribe", "/v1/subscribe", "/v1/beta", "/v1/announcements/unsubscribe", "/assets", "/v1/proof", "/v1/live/image.png", "/v1/view", "/v1/admin", "/v1/leads", "/v1/pricing", "/v1/blog", "/v1/changelog", "/scim"];
