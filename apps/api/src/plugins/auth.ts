...
const PUBLIC_PREFIXES = ["/health", "/v1/webhooks", "/v1/auth", "/v1/unsubscribe", "/v1/announcements/unsubscribe", "/assets", "/v1/proof", "/v1/admin", "/v1/leads", "/v1/pricing", "/v1/blog", "/v1/changelog", "/scim"];
