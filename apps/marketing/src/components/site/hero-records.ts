...
export const HERO_RECORDS: HeroRecord[] = [
  {
    ...
    kind: "receipt",
    verdict: "witnessed",
    note: "delivered — but the open is only a guess",
  ...
  },
  {
    ...
    kind: "campaign",
    verdict: "witnessed",
    note: "a newsletter, recorded exactly like a receipt",
  ...
  },
  {
    ...
    kind: "reply",
    verdict: "witnessed",
    note: "she wrote back, and we saw it arrive",
  ...
  },
  {
    ...
    kind: "bounce",
    verdict: "stopped",
    note: "it bounced, and the address is now blocked",
