      ...
      <div className="container">
        <Reveal className="mx-auto mb-12 max-w-2xl text-center">
          ...
          <p className="mt-4 text-balance text-lg text-muted-foreground">
            Everything here works with zero code — and everything here is also an API. Use the
            dashboard, the SDK, or both; it&apos;s the same product either way.
          </p>
        </Reveal>
        <Reveal delay={0.08} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {personas.map((p) => (
            <div key={p.who} className="flex flex-col rounded-2xl border bg-card p-6">
